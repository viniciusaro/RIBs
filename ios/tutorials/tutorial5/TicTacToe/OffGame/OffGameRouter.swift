...
protocol OffGameInteractable: Interactable, BasicScoreBoardListener, ListScoreBoardListener {
...
final class OffGameRouter: ViewableRouter<OffGameInteractable, OffGameViewControllable>, OffGameRouting {
    ...
    init(interactor: OffGameInteractable,
         ...
         scoreBoardBuilder: ListScoreBoardBuildable) {
    ...
    private var scoreBoardBuilder: ListScoreBoardBuildable
