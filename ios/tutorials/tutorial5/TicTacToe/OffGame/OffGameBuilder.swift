...
final class OffGameComponent: Component<OffGameDependency>, BasicScoreBoardDependency, ListScoreBoardDependency, ScoreItemDependency {
...
final class OffGameBuilder: Builder<OffGameDependency>, OffGameBuildable {
    ...
    func build(withListener listener: OffGameListener, games: [Game]) -> OffGameRouting {
        ...
        let scoreBoardBuilder = ListScoreBoardBuilder(dependency: component,
                                                      itemRIB: ScoreItemBuilder(dependency: component))
